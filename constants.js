export const METADATA = {
  title: "Portfolio | Emran Yonas",
  description:
    "Emran Yonas is a Full Stack and mobile Developer from Ethiopia, interested in crafting beautiful and functional applications. Emran is pursuing his undergraduate from Addis Ababa University, Ethiopia.",
  siteUrl: "https://emranyonas.tech/",
};
...
export const SOCIAL_LINKS = [
  {
    name: "mail",
    url: "mailto: emranyonas602@gmail.com",
  },
  {
    name: "linkedin",
...
export const WORK = [
  {
    company: "Recognize Design",
    title: "Full Stack Developer",
    location: "London, United Kingdom",
    range: "March 2024 – June 2024",
    responsibilities: [
      "Built responsive interfaces with React.js and Next.js, improving performance and SEO.",
      "Designed APIs and backend services using Node.js and Express.js.",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Translated design wireframes into interactive interfaces.",
      "Created secure APIs using C# and ASP.NET.",
    ],
    url: "https://cloud.com.et/",
  },
  {
    company: "Next Level Tech PLC",
    title: "Software Developer Intern",
    location: "Addis Ababa, Ethiopia",
    range: "June 2022 – October 2022",
    responsibilities: [
      "Built dynamic web apps using HTML, CSS, JavaScript, and jQuery.",
      "Ensured responsive design across devices.",
      "Managed data with MySQL databases.",
    ],
    url: "https",
  },
];
